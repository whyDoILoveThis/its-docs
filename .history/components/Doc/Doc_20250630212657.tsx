                  ...
                  >
                    {!loadedImages[item.uid] && (
                      <div className="flex justify-center">
                        <ItsSkeleton
                          ClassNames="absolute rounded-md"
                          width="300px"
                          height="200px"
                        />
                      </div>
                    ...
                    <Image
                      className={`relative z--ten rounded-md transition-opacity duration-500 ${
                    ...
                    {imageUrl && item.text && (
                      <div className="flex gap-6 mt-4">
                        <button
                          ...
                          className={`btn btn-red ${
                            loadingNewImage && "opacity-25 cursor-default"
                          }`}
                          onClick={() => {
                            setImage(null);
                            setImageUrl("");
