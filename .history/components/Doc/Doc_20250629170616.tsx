          ...
          <div className={`mb-4 w-full max-w-[500px] `} key={index}>
            <div className="flex flex-col items-center">
              ...
              {showImagePop &&
                ...
                item.style === "pic" && (
                  <div className="fixed zz-top w-screen h-screen left-0 top-0 bg-black bg-opacity-80 backdrop-blur-md flex flex-col items-center justify-center">
                    ...
                    <div className="flex gap-6 mt-4">
                      <button className="btn btn-red">NO!</button>
