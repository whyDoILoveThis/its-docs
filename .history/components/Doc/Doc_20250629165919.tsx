          ...
          <div className={`mb-4 w-full max-w-[500px] `} key={index}>
            <div className="flex flex-col items-center">
              ...
              {showImagePop &&
                ...
                item.style === "pic" && (
                  <div className="fixed zz-top w-screen h-screen left-0 top-0 bg-black bg-opacity-30 flex flex-col items-center justify-center">
                    <p>Do you want to update this pic?</p>
                    {imageUrl && item.text && (
